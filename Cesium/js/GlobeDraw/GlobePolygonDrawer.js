...
GlobePolygonDrawer.prototype = {
    ...
    startDrawPolygon: function (okHandler, cancelHandler) {
        ...
        _this.drawHandler.setInputAction(function (event) {
            ...
            var cartesian = _this.scene.globe.pick(ray, _this.scene); //yxg注释
            // var cartesian = _this.scene.pickPosition(position);  //yxg
        ...
        _this.drawHandler.setInputAction(function (event) {
            ...
            var cartesian = _this.scene.globe.pick(ray, _this.scene);  //yxg注释掉
            //  var cartesian = _this.scene.pickPosition(position);  //yxg添加
            if (!Cesium.defined(cartesian)) {
                return;
            }
    ...
    _createPoint: function (cartesian, oid) {
        ...
        var point = viewer.entities.add({
            ...
            billboard: {
                ...
                // heightReference:Cesium.HeightReference.NONE  //高度不贴地面 yxg
            }
        });
        point.oid = oid;
